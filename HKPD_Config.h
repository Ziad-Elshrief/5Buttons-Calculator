...
#define HKPD_u8R0_PORT	 	MDIO_u8_PORTA

#define HKPD_u8R1_PIN 		MDIO_u8_PIN_1
#define HKPD_u8R1_PORT	 	MDIO_u8_PORTA

#define HKPD_u8R2_PIN 		MDIO_u8_PIN_2
#define HKPD_u8R2_PORT	 	MDIO_u8_PORTA

#define HKPD_u8R3_PIN 		MDIO_u8_PIN_3
#define HKPD_u8R3_PORT	 	MDIO_u8_PORTA

/* Columns */
#define HKPD_u8C0_PIN 		MDIO_u8_PIN_4
#define HKPD_u8C0_PORT	 	MDIO_u8_PORTA

#define HKPD_u8C1_PIN 		MDIO_u8_PIN_5
#define HKPD_u8C1_PORT	 	MDIO_u8_PORTA

#define HKPD_u8C2_PIN 		MDIO_u8_PIN_6
#define HKPD_u8C2_PORT	 	MDIO_u8_PORTA

#define HKPD_u8C3_PIN 		MDIO_u8_PIN_7
#define HKPD_u8C3_PORT	 	MDIO_u8_PORTA


#define HKPD_Keys 			{{'1' , '^' , '0' , '9'},	 \
							{'<' , 'O' , '>' , '8'},	 \
							{'2' ,  'V' , '9' , '7'},	 \
							{'3' , '4' , '5' , '6'}}
